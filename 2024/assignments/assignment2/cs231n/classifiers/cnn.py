...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        preserved_dim = num_filters * int(input_dim[1] / 2) * int(input_dim[2] / 2)
        self.params[f"W2"] = np.random.normal(loc=0.0, scale=weight_scale, size=(preserved_dim, hidden_dim))
    ...
    def loss(self, X, y=None):
        ...
        activation_dim = out.shape
        out, cache2 = affine_relu_forward(out.reshape(activation_dim[0], -1), W2, b2)
